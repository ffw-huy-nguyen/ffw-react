...
class CarListCC extends Component<{ items: Car[] }, {}> {
  render() {
    return (
      <>
...
function withListItems(RenderedComponent: React.ComponentType<{items: Car[]}>, contentType: string) {
...
export default withListItems(CarListCC, 'car');
